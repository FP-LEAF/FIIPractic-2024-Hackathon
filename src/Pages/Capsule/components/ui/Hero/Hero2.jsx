                    ...
                    <div className="absolute inset-x-0 bottom-30 flex justify-center pb-10">
                        <Card className="max-w-sm bg-opacity-20 bg-white border border-gray-700">
                            ...
                            <div className="flex flex-col items-center ">
                                <img
                                    alt="Bonnie image"
                                    src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTW2uC3ywDHBqsbdzOvnCuLABF7XPON5PD0yVh-E7JX-g&s"
                                    className="mb-3 h-24 w-24 rounded-full shadow-lg"
                                />
                                <h5 className="mb-1 text-xl font-medium text-white">Popa Constantin</h5>
                                <div className="mt-4 flex space-x-3 lg:mt-6">
                                    <a
                                        href="#"
                                        className="inline-flex items-center rounded-lg bg-orange-900 px-4 py-2 text-center text-sm font-medium text-white hover:bg-cyan-800 focus:outline-none focus:ring-4 focus:ring-cyan-300 dark:bg-cyan-600 dark:hover:bg-cyan-700 dark:focus:ring-cyan-800"
                                    >
                                        Add friend
                                    </a>
                                    <a
